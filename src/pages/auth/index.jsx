...
      <div className="relative z-10 w-full max-w-4xl h-auto max-h-[40rem] lg:max-h-[36rem]
                           bg-white/5 backdrop-blur-xl border border-white/10
                           shadow-2xl rounded-3xl overflow-hidden flex flex-col lg:flex-row
                           transform scale-[0.9] sm:scale-100">

        <div className="flex flex-col gap-6 items-center justify-center p-6 sm:p-8 lg:p-10
                         bg-gradient-to-br from-blue-700 to-purple-800 text-white
                         w-full lg:w-1/2 rounded-t-3xl lg:rounded-t-none lg:rounded-l-3xl
                         text-center">
...
                         text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-white/50"
            >
...
        <div ref={formSectionRef} className="flex flex-col items-center justify-center p-6 sm:p-8 lg:p-10
                                               bg-black/40 backdrop-blur-lg w-full lg:w-1/2
...
                  className="mt-1 block w-full px-3 py-2 sm:px-4 sm:py-3
...
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 sm:py-3 sm:px-4
